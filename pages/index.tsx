  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme.gradients.background} flex items-center justify-center p-4`}>
      <div className={`bg-white rounded-2xl ${theme.shadows.lg} p-8 max-w-md w-full text-center`}>
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Let&apos;s hang out</h1>
        <p className="text-gray-600 mb-8">
          Enter your lovely name so I can use it on the next screen.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {isLoading ? 'Loading...' : "Let's see what this guy has in store"}
          </button>
        </form>
